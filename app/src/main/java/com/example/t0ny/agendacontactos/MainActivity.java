...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
            ...
            if (BAJA == requestCode) {
                if (resultCode == Activity.RESULT_OK) {
                    if (data.hasExtra("borrar")) {
                        ...
                        Contacto contacto = data.getParcelableExtra("borrar");  //se borra contacto que previamente hemos pasado con un Intent desde la actividad BorrarDatos
                ...
                if (LISTAR == requestCode) {
                    if (resultCode == Activity.RESULT_OK) {
                        if (data.hasExtra("modificado")){
                            listaContactos= data.getParcelableArrayListExtra("modificado");
                        }
    ...
    protected void onResume() {
        super.onResume();
        if (getIntent().hasExtra("modificado")){
            listaContactos = getIntent().getParcelableArrayListExtra("modificado");
        }
    }
